...
Download the latest `.semod` from the
[Releases page](https://github.com/dezgard/StationTabStats/releases/latest),
then install and enable it with Star Empire Mod Manager.
